...
export class ToString implements Expresion {
    ...
    getValorImplicito(ent: Entorno, arbol: AST) {
            ...
            //TOINT
            if (tipoValor != Tipo.NULL && tipoValor != Tipo.VOID) 
            {
                return valor.toString();
            } else {
                return new Excepcion(this.linea, this.columna, "Error Semantico", "La Funcion toString No Puede Convertir un tipo de Dato Null o Vacio a una Cadena",ent.getEntorno());
            }
