...
export class ToDouble implements Expresion {
    ...
    getValorImplicito(ent: Entorno, arbol: AST) {
            ...
            if (tipoValor == Tipo.INT) 
            {
                ...
                return new Excepcion(this.linea, this.columna, "Error Semantico", "La Funcion toDouble solo permite Numeros Enteros para convertirlos a Decimales",ent.getEntorno());
            }
